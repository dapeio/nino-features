...
| `search` | [Elements search](features/Search/README.md) | `content` | 1.1.0 | `^1.0` | A locale-aware fuzzy search index over configured Element fields, rebuilt on every save and from the Search panel |
