...
| `search` | [Elements search](features/Search/README.md) | `content` | 1.1.0 | `^1.3` | Ein sprachbewusster unscharfer Suchindex über konfigurierte Element-Felder, neu gebaut bei jedem Speichern, mit einem Shortcode, der die Treffer auf jeder Seite zeichnet, unter einem Formular, das das Projekt selbst schreibt |
